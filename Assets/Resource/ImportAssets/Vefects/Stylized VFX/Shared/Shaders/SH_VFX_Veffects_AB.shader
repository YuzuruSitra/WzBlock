...
Shader "SH_VFX_Veffects_AB"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			v.vertex.xyz += ( ( ase_worldPos - _WorldSpaceCameraPos ) * ( ( _CamOffet_Amount + v.texcoord3.xy.y ) * 0.01 ) );
			v.vertex.w = 1;
		}
...
/*ASEBEGIN
Version=18921
7;6;2546;1373;1754;126.5;1;True;True
Node;AmplifyShaderEditor.TextureCoordinatesNode;11;-812.2227,752.5864;Inherit;False;3;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;12;-800.1973,651.6475;Inherit;False;Property;_CamOffet_Amount;CamOffet_Amount;2;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;4;-611,7.5;Inherit;False;Property;_Emissive_Intensity;Emissive_Intensity;1;0;Create;True;0;0;0;False;0;False;1;3;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=EB4E5631B22BD6646022DADD33677EAD396BD3F7